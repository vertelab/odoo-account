...
class AccountMove(models.Model):
    ...
    analytic_reviewer_ids = fields.Many2many('res.users', string="Cost Center Reviewers", compute=get_reviewers_from_line, store=True, column1='account_move_column1', column2='res_user_column2')
