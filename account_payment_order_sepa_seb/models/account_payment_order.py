...
class AccountPaymentOrder(models.Model):
    ...
    def generate_party_agent(
        ...
        logger.warning("partner_bank: " + f"{partner_bank}")
        logger.warning("partner_bank.bank_bic: " + f"{partner_bank.bank_bic}")
        if partner_bank.bank_bic:
            ...
            if order == "B" or (order == "C" and gen_args["payment_method"] == "DD" or order == "C" and re.match('\d{3,4}-\d{4}$', partner_bank.acc_number)):
                ...
                logger.warning("partner_bank.acc_number: " + f"{partner_bank.acc_number}")
