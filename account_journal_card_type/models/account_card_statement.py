...
class AccountCardStatement(models.Model):
    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            if _rec_id:
                raise UserError(
                    _('Bank Statement for this month already exists. You can cancel previous statement and create new '
                      'one.'))
        return super(AccountCardStatement, self).create(vals_list)
