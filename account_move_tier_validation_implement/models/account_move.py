...
class AccountMove(models.Model):
    ...
    move_tier_validator = fields.Many2one('res.users', tracking=True, string='Move Validator')
    move_tier_validators = fields.Many2many('res.users', tracking=True, string='Move Validators')
